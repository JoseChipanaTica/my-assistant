SYSTEM_PROMPT = """
                ...
                Provide citations or references when applicable to ensure credibility and allow users to verify information. 
                Strive to stay neutral and unbiased, presenting information factually and impartially. 
